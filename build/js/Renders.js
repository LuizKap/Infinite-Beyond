...
export async function Enterfullscreen(target) {
    ...
    const exit = imageConstructor('img', 'exit', 'Exit FullScreen Game', 'exit-fullscreen', 'delete-button.png');
    ...
    if (!game_movies || !game_movies.results || game_movies.results.length === 0) {
        ...
        const arrow_right = imageConstructor('img', 'Arrow', 'Right Arrow', 'right-arrow', 'rightArrow.png');
        const arrow_left = imageConstructor('img', 'Arrow', 'Left Arrow', 'left-arrow', 'leftArrow.png');
